...
public class Basic_Assign_1 extends BaseSetup{
	public Basic_Assign_1() {
	...
	public void captureScreenshot(String methodName, boolean isPass){
		...
		try {
			...
			String screenshotPath = "./test-output/screenshots/Basic_Assign/" + methodName + ".png";
	...
	public void captureBufferedImage(String methodName, boolean isPass) throws IOException{
		...
		try {
			...
			String screenshotPath = "./screenshots/Basic_Assign/" + methodName + ".png";
