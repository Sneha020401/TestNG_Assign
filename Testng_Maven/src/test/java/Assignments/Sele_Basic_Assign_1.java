...
public class Sele_Basic_Assign_1 extends BaseSetup{
	public Sele_Basic_Assign_1() {
		String htmlName = "SeleBasicAssign1.html";
	...
	public void T9_switchAlertDismiss() throws InterruptedException, IOException {
		...
		captureBufferedImage("T9_switchAlertDismisscapture");
		Thread.sleep(2000);
	...
	public void T12_mouseOverAction() throws InterruptedException, IOException {
		...
		exttest.info("MouseOverAction Capture");
		...
		captureBufferedImage("T12_mouseOverCapture");
		Thread.sleep(3000);
		//System.out.println("aftercapture1");
		option.click();
	...
	public void T14_webTableFixedHeader() throws InterruptedException {
		...
		for (WebElement row : rows) {
			...
			if (!cells.isEmpty()) {
				...
				tableContent += rowContent + "<br>";
			}
		}
		exttest.info(tableContent);
